...
static const char *fonts[]          = { "Hack Nerd Font:size=24" };
static const char dmenufont[]       = "Hack Nerd Font:size=24";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_dmenuwondnormbg, "-nf", col_dmenuwondnormfg, "-sb", col_dmenuwondselsbg, "-sf", col_dmenuwondselfg, NULL };
